...
const CrescentMoonIcon = ({ width = 35, height = 35, style }: any) => {
    return (
        <View style={style}>
            <Svg
                height={height}
                width={width}
                viewBox="0 0 512 512" // Matching the SVG's original viewBox
            >
                <Path
                    fill="#00E7F0"
                    d="M293.305,18.485C263.786,6.574,231.562,0,197.827,0C152.83,0,108.561,11.849,69.804,34.267
            ...
            C453.815,148.579,387.302,56.41,293.305,18.485z"
                ...
                <Path
                    fill="#00D7DF"
                    d="M58.185,54.412c0,8.307,4.428,15.985,11.619,20.145c64.605,37.373,104.738,106.898,104.738,181.447
            c0,74.543-40.133,144.066-104.738,181.439c-7.191,4.16-11.619,11.838-11.619,20.145s4.428,15.985,11.619,20.145
...
export default CrescentMoonIcon;
